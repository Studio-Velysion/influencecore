...
Les scripts sont dans `postiz-app-main`, **PAS** dans `InfluenceCore`.
...
### ❌ MAUVAIS : Depuis InfluenceCore
```powershell
PS H:\Studio Velysion CreatorHub\InfluenceCore> npm run dev:frontend
# ❌ Erreur : Missing script
```

### ✅ BON : Depuis postiz-app-main
```powershell
PS H:\Studio Velysion CreatorHub\InfluenceCore\postiz-app-main> pnpm run dev:frontend
# ✅ Fonctionne !
```
